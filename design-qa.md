# Design QA — Metkagram entry, method page and tag rules
...
- Implementation: `http://127.0.0.1:4173/en/`, `/en/method/`, and `/en/explore/english/dialogues/iglIrNfAke7r4OZ0KxuB/`.
- Browser evidence: `reports/design-audit/2026-07-13/07-local-home-top-final.png`, `reports/design-audit/2026-07-13/06-tag-rule-open.png`, and `reports/design-audit/2026-07-14/01-local-method.png`.
...
- `npm run verify`: passed — build, 13 unit/content tests, and 4,994 internal HTML links.
- `npm run test:e2e`: passed — 15 tests across desktop and mobile, including the new method-research and desktop hierarchy checks; one expected desktop-only skip remains.
