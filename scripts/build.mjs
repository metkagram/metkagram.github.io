...
export function loadPatternAnnotations(content) {
  return loadPracticeAnnotationLayer(content, ROOT).items;
}
...
function build() {
  // dist/ is cleaned and the canonical release artifacts (CITATION.cff,
  // public/rights.json) are regenerated by the source stage
  // (scripts/stages/source.mjs) before this renderer runs.
