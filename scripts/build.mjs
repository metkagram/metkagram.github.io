...
function build() {
  ...
  const report = {
    ...
    externalSteps: ["Enable GitHub Pages with GitHub Actions as the source after the initial push.", "Keep the MetalHatsCats SRS compatibility API and transfer utility available during migration."]
  };
