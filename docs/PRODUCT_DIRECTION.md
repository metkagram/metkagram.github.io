...
A pattern should support a short loop rather than passive browsing:
...
AI may generate context, feedback and new examples around this loop. AI is the tutor/interface, not the canonical curriculum.
...
The public repository is a publication and evaluation layer. It may contain selected annotated documents, selected reasoning frames, evaluation fixtures, public schemas, Pattern Lens rules and derived graph relationships.
...
- streaks, gamification and account systems before the core loop is useful;
...
Each stage should strengthen the same learning object rather than create a parallel product.
...
- percentage of Lens matches that lead to opening a pattern or a related pattern;
- completion of one short retrieval attempt after viewing a pattern;
- repeat use of stable pattern IDs;
