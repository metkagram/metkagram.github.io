...
test('refreshed EN/DE emphasis remains readable and grammar help works at viewport edges', async({page})=>{
 ...
 for(const language of ['en','de']){
  const sentence=page.locator(`.pattern-comparison-list > li:first-child [lang="${language}"] p`);
 ...
 const tags=page.locator('.pattern-comparison-list > li:first-child [data-tag-trigger]');
