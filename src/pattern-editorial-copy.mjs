...
const C1_RU_TITLES = {
  AGR: "Я вижу смысл в …, хотя я бы …",
  ARG: "Аргумент в пользу … основан на предположении, что …",
  CAU: "Поскольку …, …, из-за чего …",
  CLR: "Если сформулировать … точнее, …",
  CMP: "Ключевое различие между … и … — …",
  CND: "Если бы … произошло раньше, …, возможно, …",
  DGR: "Не только …, но и … — усилительная инверсия",
  EVD: "Имеющиеся данные указывают на …, хотя …",
  HED: "Было бы преждевременно заключать, что …, прежде чем …",
  LNK: "Тем не менее …; в более широком контексте …",
  MOD: "Чтобы … сработал, … должен …",
  NEG: "Можем ли мы взять … за основу компромисса при условии, что …?",
  OPI: "После тщательного рассмотрения я считаю, что …, особенно учитывая …",
  PRB: "Есть реальная вероятность, что …, если …",
  PRO: "Пишу, чтобы уточнить …, прежде чем …",
  PSV: "Перед … объект … подвергается действию",
  QNN: "Что могло бы помешать … выполнить …?",
  REP: "… подчеркнул(а), что …, а не …",
  STO: "Оглядываясь назад, … стал моментом, когда …",
  TAS: "Мы выполняем действие с момента … и продолжаем сейчас"
};
