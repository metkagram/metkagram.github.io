...
export function practicePage(locale, patterns) {
  ...
  return layout({ locale, pathname, title: locale === "en" ? "Practice 236 reusable language patterns — Metkagram" : "Практика 236 речевых моделей — Metkagram", description: t.practiceIntro, body, structuredData: [breadcrumbJson(pathname, t.practiceTitle, locale), { "@context": "https://schema.org", "@type": "ItemList", name: t.practiceTitle, numberOfItems: patterns.length }] });
}
...
export function gatewayPage() {
  const body = `<section class="gateway"><header class="gateway-header"><a class="wordmark" href="/ru/" aria-label="Metkagram"><img src="/assets/logo/metkagram-logo-light.svg" width="800" height="200" alt="Metkagram"></a><p>01 · language patterns</p></header><div class="gateway-stage"><div class="gateway-copy"><p class="eyebrow">Metkagram</p><h1><span>Read the phrase.</span><span>Notice the pattern.</span></h1><p class="lede">A workspace for English and German phrases you can understand, remember and use again.</p><nav aria-label="Choose interface language"><a href="/ru/" lang="ru"><strong>Русский</strong><span>Открыть главную <i aria-hidden="true">→</i></span></a><a href="/en/" lang="en"><strong>English</strong><span>Open home <i aria-hidden="true">→</i></span></a></nav></div><div class="gateway-field" aria-hidden="true"><span class="field-line field-line-one">phrase <b></b> pattern <b></b> phrase <b></b> pattern</span><span class="field-line field-line-two">read <b></b> notice <b></b> reuse <b></b> return</span><span class="field-line field-line-three">meaning <b></b> structure <b></b> memory</span><em>01–03</em></div></div><footer><span>Metkagram · B2–C1</span><a href="https://github.com/metkagram/metkagram.github.io">GitHub</a><a href="/llms.txt">llms.txt</a></footer></section>`;
