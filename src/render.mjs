...
export function localeHome(locale, content) {
  ...
  const body = `<section class="home-hero section-pad">
    <div class="home-intro"><div class="home-copy"><h1>${t.statement}</h1></div><nav class="home-links" aria-label="${t.homeJourneyLabel}"><a class="primary-link" href="/${locale}/explore/"><span>${t.homeExplore}</span><span aria-hidden="true">→</span></a><a href="/${locale}/practice/"><span>${t.navPractice}</span><span aria-hidden="true">→</span></a><a href="/${locale}/review/"><span>${t.navReview}</span><span aria-hidden="true">→</span></a><a href="/${locale}/method/"><span>${t.navMethod}</span><span aria-hidden="true">→</span></a></nav></div>
  </section>
  ...
  if (kind === "privacy") {
    return en ? {
      ...
      sections: [
        ...
        ["Information on the website", "The public website does not require an account. It does not use advertising trackers. Your review progress stays in your browser, where you can export or import it as JSON."],
