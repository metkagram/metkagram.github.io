...
export function gatewayPage() {
  const body = `<section class="gateway"><a class="wordmark" href="/ru/" aria-label="Metkagram"><img src="/assets/logo/metkagram-logo-light.svg" width="800" height="200" alt="Metkagram"></a><div class="gateway-content"><p class="eyebrow">Metkagram · language patterns</p><h1>Read the phrase. Notice the pattern.</h1><p class="lede">A calm, annotated workspace for English and German phrases you can understand and reuse.</p><nav aria-label="Choose interface language"><a href="/ru/" lang="ru"><strong>Русский</strong><span>Открыть главную →</span></a><a href="/en/" lang="en"><strong>English</strong><span>Open home →</span></a></nav></div><footer><a href="https://github.com/metkagram/metkagram.github.io">GitHub</a><a href="/llms.txt">llms.txt</a></footer></section>`;
