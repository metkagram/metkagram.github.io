...
export function practicePage(locale, patterns) {
  ...
  return layout({ locale, pathname, title: locale === "en" ? "Practice 260 reusable language patterns — Metkagram" : "Практика 260 речевых моделей — Metkagram", description: t.practiceIntro, body, structuredData: [breadcrumbJson(pathname, t.practiceTitle, locale), { "@context": "https://schema.org", "@type": "ItemList", name: t.practiceTitle, numberOfItems: patterns.length }] });
}
