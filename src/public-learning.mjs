...
export const publicLearningRules = [
  ...
  rule("en-compare-compared", "en", /\bcompared (?:to|with)\b|\bcompare(?:d)? (?:them|the two|these|those)\b/iu, "Compare", "compare-alternatives", "C1CMP001", "direct", "explicit comparison cue", 8),
  ...
  rule("de-compare", "de", /\b(?:im vergleich zu|im vergleich mit|verglichen mit|wohingegen)\b/iu, "Compare", "compare-alternatives", "C1CMP001", "direct", "comparison cue", 10),
